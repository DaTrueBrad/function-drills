...
function faveColorFinder(color) {
  switch(color) {
    ...
    case 'black':
      ...
      break;
    default:
      console.log('you need to evaluate your color choice');
...
function theEliminator(person1, person2) {
...
let totalFrogs = buyChocolateFrogs(12)
...
let totalFrogs2 = buyChocolateFrogs2(22)
